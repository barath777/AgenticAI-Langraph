...
class RCAAgent:
    ...
    def perform_root_cause_analysis(self, alert_json, similar_alerts):
        try:
            ...
            - Correlation: <two-line correlation>

            In Correlation provide what exactly is the correlation between the Historical_Alerts_Resolutions.csv, applications_logs.csv, kpi_metrics.csv and production_deployments.csv and also explain the correlation between them.
            DO NOT provide any additional explanation or narrative.
            Identify what exactly is the alert and perform root cause analysis based on the alert
